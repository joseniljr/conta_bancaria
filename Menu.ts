...
export function main() {
    ...
    //Criar a instância da Classe Controller da conta.
    let contas: ContaControler = new ContaControler()
    

    // Criando variáveis que serão usadas nas opções do menu
    ...
    //Criando algumas contas no inicio do sistema para testes
        ...
        switch (opcao) {
            ...
            case 4:
                ...
                if (conta != null) {
                   ...
                   switch (tipo) {
                    case 1:
                        console.log("Digite o limite de credito da conta (R$: ")
                        limite = readlinesync.questionFloat("")
                        contas.atualizar(
...
export function sobre(): void {
    console.log("\n*****************************************************");
    console.log("Projeto Desenvolvido por: Josenil Soares ");
    console.log("Generation Brasil - josenils@generation.org");
    console.log("https://github.com/joseniljr/conta_bancaria.git");
    console.log("*****************************************************");
}
